        ...
        <div className="columns">
          <div className="column columns is-justify-content-center">
            ...
            <div className="column is-narrow credit pl-2 pt-0">
              BY-COVID project has<br />received funding from the<br />European Union&apos;s Horizon Europe<br />research and innovation programme<br />under grant agreement No. 101046203.
            </div>
          </div>
        </div>
      </div>
