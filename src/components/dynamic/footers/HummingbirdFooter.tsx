        ...
        <div className="columns">
          <div className="column columns is-justify-content-center">
            ...
            <div className="column is-narrow credit pl-2 pt-0">
              HumMingBird project has<br />received funding from the<br />European Union&apos;s Horizon 2020<br />research and innovation Programme<br />under grant agreement No. 870661.
            </div>
          </div>
        </div>
      </div>
