    ...
    <div className="columns is-flex is-flex-direction-column is-vcentered pb-6">
      ...
      <div className="column px-6">
        ...
        <div className="text-container">
          <p>This is the CESSDA Data Catalogue (CDC) version 4.0.0 released on 2025-06-16. It contains descriptions of the more than 39,000 data collections held by CESSDA’s Service Providers (SPs), originating from over 20 European countries. The CDC is a one-stop shop for searching and discovering European social science data. The presented data includes a range of data types including quantitative, qualitative or mixed-modes data, covering both cross-sectional and longitudinal studies, as well as recently collected and historical data. The metadata (study descriptions) are presented in the language as originally provided by the organisations producing the metadata. Some publishers provide study descriptions both in English and in the local language, some only in either English or in the local language. Currently, about 75% of study descriptions are available in English.</p><p>The <a href="/documentation/">User Guide</a> presents an overview of how to use the data catalogue for searching, covering basic search operations, application of filters and advanced search functionalities.</p>
